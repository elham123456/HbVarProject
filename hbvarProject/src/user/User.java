...
public class User {
	...
	/*in order to separate the 3 columns of the data base and distinguish the spaces in the name*/
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		* -----------------------------------------------------*/
		...
		/*-----------------------------------------------------------
		*  Display the entry exceptions that are ignored in the grammar
		* -----------------------------------------------------------*/
		...
		if (mode.getVExists()) {
			handler.handle(lineIndex, brException);
		}
		...
		switch(mode.getMode()){
			case 0:
				System.err.println("Entry non recognized.");
				break;
			case 1:
			...
			case 4:
				...
				break;
			default:
				System.err.println("Entry not valid.");
				break;
		}
