...
/*the columns name, mutation and hgvsname are separated by separator*/
  ...
  static final public String or() throws ParseException {String s;
  Token t;
...
{if ("" != null) return "Or";}
  ...
  static final public String and() throws ParseException {String s;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 18:{
      jj_consume_token(18);
...
/*with one_line we parse one line and return an object of type Entry*/
  static final public Entry one_line() throws ParseException {Entry entry;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case DIGIT:
      case NUMBER:
...
{if ("" != null) return entry;}
      ...
      case nextline:{
        jj_consume_token(nextline);
{if ("" != null) return new Entry("newLine");}
        break;
        }
      case 0:{
        jj_consume_token(0);
{if ("" != null) return new Entry("EOF");}
        break;
        }
      default:
        jj_la1[2] = jj_gen;
...
error_skipto(nextline);
                {if ("" != null) return new Entry("unexpected");}
    }
    throw new Error("Missing return statement in function");
  }

  static final public String insideParenthesis() throws ParseException {Token t;//t is an image and that is why for its recovery we use .image
...
{if ("" != null) return txt.toString();}
    throw new Error("Missing return statement in function");
  }

  static final public String texte() throws ParseException {Token t;
  StringBuilder txt = new StringBuilder();
  String s;
  AminoAcid amino;
  Protein prot;
    ...
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case spaceSeparator:{
        jj_consume_token(spaceSeparator);
txt = txt.append(" ");
        break;
        }
      case UNEXPECTED:{
...
{if ("" != null) return txt.toString();}
  ...
  static final public AminoAcid aminoAcid() throws ParseException {String s;
  AminoAcid amino;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 22:{
      jj_consume_token(22);
...
{if ("" != null) return amino;}
    throw new Error("Missing return statement in function");
  }

  static final public Protein proteinchain() throws ParseException {Token t;
  String s;
  Protein prot;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 42:{
...
prot = new Protein(s);
  ...
  static final public String number() throws ParseException {String num = "";
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
      t = jj_consume_token(NUMBER);
...
/*<PARENTHESIS> txt <PARENTHESIS>*/
  static final public String index1() throws ParseException {String indTxt = " ";
    ...
    jj_consume_token(PARENTHESIS);
{if ("" != null) return indTxt;}
    throw new Error("Missing return statement in function");
  }

/*<PARENTHESIS> num <PARENTHESIS>*/
  static final public int index2() throws ParseException {String indNum;
    jj_consume_token(PARENTHESIS);
    indNum = number();
    jj_consume_token(PARENTHESIS);
{if ("" != null) return Integer.valueOf(indNum);}
    throw new Error("Missing return statement in function");
  }

  static final public ArrayList<Protein> protein() throws ParseException {Protein p1, p2;
...
{if ("" != null) return proteinPair;}
    throw new Error("Missing return statement in function");
  }

  static final public AminoAcidSeq aminoAcidSequence() throws ParseException {ArrayList<AminoAcid> seq = new ArrayList<AminoAcid>();
        AminoAcid amino;
    amino = aminoAcid();
seq.add(amino);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
AminoAcidSeq seqClass = new AminoAcidSeq(seq);
          {if ("" != null) return seqClass;}
    throw new Error("Missing return statement in function");
  }

  static final public AminoAcidSeq aminoAcidSequenceReverse() throws ParseException {ArrayList<AminoAcid> seq = new ArrayList<AminoAcid>();
        AminoAcid amino;
    label_4:
    while (true) {
      amino = aminoAcid();
...
/*replace with: Hb Antalya beta 2 - 5 His-Leu-Thr-Pro replaced with His-Ser-Asp-Ser HBB:c.[16delC;8_9insC]*/
  static final public MutationType replaceSet(Header header, AminoAcidSeq seqOld) throws ParseException {Replacement replace;
  AminoAcidSeq seqNew;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CHANGETO:{
...
/*example: Hb Zunyi beta 147, Stop>Gln; modified C-terminal sequence: (147)Gln-Ala-Arg-Phe-Leu-Ala-Val-Gln-Phe-Leu-Leu- Lys-Val-Pro-Leu-Phe-Pro-Lys-Ser-Asn-(167)Tyr-COOH HBB:c.442T>C*/
  static final public AddChain addChain(Header header) throws ParseException {AddChain addChain;
  AminoAcidSeq seq;
  AminoAcid amino;
...
{if ("" != null) return addChain;}
    throw new Error("Missing return statement in function");
  }

/*add one amino acid or an interval(addChain or AddAcid)*/
  static final public MutationType addSet(Header header) throws ParseException {MutationType mutationType;
  AminoAcid amino;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 52:{
      jj_consume_token(52);
...
/*example : Hb Pohnpei***alpha2 137(H20) - 138(H21) Thr-Ser->0 AND inserted Thr*/
  static final public MutationType deleteSet(Header header, AminoAcidSeq seq) throws ParseException {DeleteSet delete;
...
/*A set that contains the mutations replaceSet, deleteSet*/
  static final public MutationType modify(Header header) throws ParseException {AminoAcidSeq seq;
...
/*contains protein [or protein] index(text) [- index(text)] */
  static final public Header header() throws ParseException {//elements which help recovery
...
/*example: Hb Bronx Lys-Val-Leu- inserted between codons 68(E12) and 69(E13) of beta HBB:c.207_208insAAAGTGCTC*/
  static final public Insertion insertion() throws ParseException {//elements which help recovery
  AminoAcidSeq seq;
...
{if ("" != null) return insertion;}
    throw new Error("Missing return statement in function");
  }

/*the third column hgvsName*/
  static final public String HGVSname() throws ParseException {String s;
    s = texte();
{if ("" != null) return s;}
    throw new Error("Missing return statement in function");
  }
...
/*the first column: the mutation name*/
  static final public String variantName() throws ParseException {StringBuilder name= new StringBuilder();
  String txt;
  Protein prot;
    txt = texte();
name.append(txt);
...
there is no need to recover the list of proteins since we do it ione time in mutationType()*/
  static final public ArrayList<MutationType> type() throws ParseException {Header header;
        MutationType mutationType;
...
beta 139(H17) Asn->0 */
  static final public 
ArrayList<Mutation> mutationType() throws ParseException {Header header;
        Mutation mutation;
...
/*<mutation OR mutation OR mutation OR >*/
  static final public ArrayList<Mutation> mutation() throws ParseException {ArrayList<Mutation> mutationsFound = new ArrayList<Mutation>();
        ArrayList<Mutation> mutations = new ArrayList<Mutation>();
...
/*mutation = mutatiotype and mutationtype and mutationtype and...*/
  static final public Entry entry() throws ParseException {Entry entry;
